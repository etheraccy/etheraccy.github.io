const contractFunctions = function() {
  ...
  function createGameLink(args) {
    ...
    alert("Copy Your Game Link","https://etheraccy.github.io/?" + orderString);
